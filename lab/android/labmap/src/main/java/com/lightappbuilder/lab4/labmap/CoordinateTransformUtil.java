...
public class CoordinateTransformUtil {
    ...
    public static final int COOR_TYPE_BD09 = 0;
    ...
    public static double[] transform(double lng, double lat, int inputCoorType, int outputCoorType) {
        if (inputCoorType == outputCoorType) {
            return new double[] {lng, lat};
        }
        switch (inputCoorType) {
            case COOR_TYPE_BD09:
                if (outputCoorType == COOR_TYPE_GCJ02) {
                    return bd09togcj02(lng, lat);
                }
                return bd09towgs84(lng, lat);
            case COOR_TYPE_GCJ02:
                if (outputCoorType == COOR_TYPE_BD09) {
