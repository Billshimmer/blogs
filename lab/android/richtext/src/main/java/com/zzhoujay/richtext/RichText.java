    ...
    public void into(TextView textView) {
        ...
        /* TODO 会报错
          Caused by: java.lang.NullPointerException: Attempt to read from field 'int android.view.ViewGroup$LayoutParams.width' on a null object reference
            ...
            at android.widget.TextView.setText(TextView.java:4130)
            at android.widget.TextView.setText(TextView.java:3978)
            at android.widget.TextView.setText(TextView.java:3953)
            at android.widget.TextView.setMovementMethod(TextView.java:1762)
         */
