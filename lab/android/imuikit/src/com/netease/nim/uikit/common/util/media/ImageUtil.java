...
import com.netease.nim.uikit.viewholder.MsgViewHolderImageThumbBase;
...
public class ImageUtil {
    ...
    public static String makeThumbnail(Context context, File imageFile) {
    	...
    	boolean result = scaleThumbnail(
                imageFile,
                thumbFile,
                MsgViewHolderImageThumbBase.getImageMaxEdge(),
                MsgViewHolderImageThumbBase.getImageMinEdge(),
                CompressFormat.JPEG,
                60);
    	if (!result) {
