...
public class AutoRefreshListView extends ListView {
        ...
        OnScrollListener listener = new OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                if (scrollState == SCROLL_STATE_IDLE && state == State.RESET) {
                    ...
                    //Log.i(TAG,"------------getFirstVieiblPosition:"+getFirstVisiblePosition()+" getHeaderViewCount():"+getHeaderViewsCount()+" getCount():"+getCount()+"reachTop:"+reachTop);
                    if (reachTop) {
                        onRefresh(true);
                    } else {
    ...
    private void onRefresh(boolean start) {
        if (refreshListener != null) {
            ...
            if (firstVisibleChild != null) {
                ...
                //Log.i(TAG,"----------offsetY:"+offsetY+"start:"+start);
            }
    ...
    private void resetRefreshView(int count, int requestCount) {
        if (currentMode == Mode.START) {
             ...
             */
            Log.i("个人测试:","AutoRefreshListView:resetRefreshView改变了判断头部或尾部是否显示的问题，不知道有什么影响");
    ...
    private void onTouchBegin(MotionEvent event) {
        //Log.i(TAG,"----------onTouchBegin:refreshableStart:"+refreshableStart);
    ...
    private void onTouchMove(MotionEvent event) {
        ...
        //Log.i(TAG,"----------onTouchMove:offsetY:"+offsetY);
