...
// 基于 https://github.com/Solartisan/WaveSideBar/commit/88767043ae2c4f1fe879506f549cd765fa41463b
public class SideIndexView extends View {
    ...
    // 渲染字母表
    private List<String> mLetters = Arrays.asList("");
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.sideindexview_textSize_sidebar);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.sideindexview_large_textSize_sidebar);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.sideindexview_textSize_sidebar_padding);
        mRadius = context.getResources().getDimensionPixelSize(R.dimen.sideindexview_radius_sidebar);
        mBallRadius = context.getResources().getDimensionPixelSize(R.dimen.sideindexview_ball_radius_sidebar);
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SideIndexView);
            mTextColor = a.getColor(R.styleable.SideIndexView_sidebarTextColor, mTextColor);
            mTextColorChoose = a.getColor(R.styleable.SideIndexView_sidebarChooseTextColor, mTextColorChoose);
            mTextSize = a.getFloat(R.styleable.SideIndexView_sidebarTextSize, mTextSize);
            mLargeTextSize = a.getFloat(R.styleable.SideIndexView_sidebarLargeTextSize, mLargeTextSize);
            mWaveColor = a.getColor(R.styleable.SideIndexView_sidebarBackgroundColor, mWaveColor);
            mRadius = a.getInt(R.styleable.SideIndexView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.sideindexview_radius_sidebar));
            mBallRadius = a.getInt(R.styleable.SideIndexView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.sideindexview_ball_radius_sidebar));
            a.recycle();
        }
