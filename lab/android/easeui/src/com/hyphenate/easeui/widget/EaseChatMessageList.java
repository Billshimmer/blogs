...
public class EaseChatMessageList extends RelativeLayout{
    ...
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        ...
        //自定义添加头部
        headerView = View.inflate(context, R.layout.custom_load_header, null);
        pbMore = (ProgressBar) headerView.findViewById(R.id.pb_more);
        pbMore.setVisibility(View.INVISIBLE);//默认不显示，防止一开始没有聊天记录的时候出现
