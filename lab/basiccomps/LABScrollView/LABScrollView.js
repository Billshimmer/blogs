 ...
 */
const LABScrollView = React.createClass({
  propTypes: {
    ...View.propTypes,
    /**
   ...
   */
  getScrollResponder: function(): LABScrollView {
    return this;
  },
...
if (Platform.OS === 'android') {
  ...
  AndroidScrollView = requireNativeComponent('LABScrollView', LABScrollView, nativeOnlyProps);
  ...
  LABScrollView = requireNativeComponent('RCTScrollView', LABScrollView, nativeOnlyProps);
}

module.exports = LABScrollView;
