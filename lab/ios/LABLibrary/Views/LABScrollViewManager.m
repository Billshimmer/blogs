...
#import "LABScrollViewManager.h"

#import <React/RCTBridge.h>
#import "LABScrollView.h"
#import <React/RCTUIManager.h>

@interface LABScrollView (Private)
...
@implementation LABScrollViewManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [[LABScrollView alloc] initWithEventDispatcher:self.bridge.eventDispatcher];
}
                  ...
                  callback:(RCTResponseSenderBlock)callback)
{
  [self.bridge.uiManager addUIBlock:
   ^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, LABScrollView *> *viewRegistry) {

    LABScrollView *view = viewRegistry[reactTag];
    if (!view || ![view isKindOfClass:[LABScrollView class]]) {
      RCTLogError(@"Cannot find LABScrollView with tag #%@", reactTag);
      return;
    }
