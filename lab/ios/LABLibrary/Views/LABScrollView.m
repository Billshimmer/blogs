...
CGFloat const LAB_ZINDEX_DEFAULT = 0;
CGFloat const LAB_ZINDEX_STICKY_HEADER = 50;

@interface LABScrollEvent : NSObject <RCTEvent>
...
- (LABScrollEvent *)coalesceWithEvent:(LABScrollEvent *)newEvent
{
 ...
 */
@interface LABCustomScrollView : UIScrollView<UIGestureRecognizerDelegate>

@property (nonatomic, copy) NSIndexSet *stickyHeaderIndices;
@property (nonatomic, assign) BOOL centerContent;
@property (nonatomic, strong) LABRefreshControl *rctRefreshControl;

@end


@implementation LABCustomScrollView
{
...
- (UIView *)contentView
{
  return ((LABScrollView *)self.superview).contentView;
}
...
{
  if ([self _shouldDisableScrollInteraction] && ![[RCTUIManager JSResponder] isKindOfClass:[LABScrollView class]]) {
...
- (void)dockClosestSectionHeader
{
  ...
  [_stickyHeaderIndices enumerateIndexesWithOptions:0 usingBlock:
   ^(NSUInteger idx, BOOL *stop) {
    ...
    header.layer.zPosition = LAB_ZINDEX_DEFAULT;
  ...
  currentHeader.layer.zPosition = LAB_ZINDEX_STICKY_HEADER;
  ...
  if (previousHeader) {
    ...
    previousHeader.layer.zPosition = LAB_ZINDEX_STICKY_HEADER;
  }
}
...
- (void)setRctRefreshControl:(LABRefreshControl *)refreshControl
{
...
@implementation LABScrollView
{
  RCTEventDispatcher *_eventDispatcher;
  LABCustomScrollView *_scrollView;
  UIView *_contentView;
...
- (instancetype)initWithEventDispatcher:(RCTEventDispatcher *)eventDispatcher
{
  ...
  if ((self = [super initWithFrame:CGRectZero])) {
    ...
    _scrollView = [[LABCustomScrollView alloc] initWithFrame:CGRectZero];
...
- (void)insertReactSubview:(UIView *)view atIndex:(NSInteger)atIndex
{
  ...
  if ([view isKindOfClass:[LABRefreshControl class]]) {
    [_scrollView setRctRefreshControl:(LABRefreshControl *)view];
  } else {
...
- (void)removeReactSubview:(UIView *)subview
{
  ...
  if ([subview isKindOfClass:[LABRefreshControl class]]) {
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  LABScrollEvent *scrollEvent = [[LABScrollEvent alloc] initWithEventName:eventName
...
@implementation RCTEventDispatcher (LABScrollView)
...
- (void)sendFakeScrollEvent:(NSNumber *)reactTag
{
  ...
  LABScrollEvent *fakeScrollEvent = [[LABScrollEvent alloc] initWithEventName:eventName
                                                                     reactTag:reactTag
                                                                   scrollView:nil
                                                                     userData:nil
                                                                coalescingKey:0];
